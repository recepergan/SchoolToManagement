...
public class Servant extends Worker implements Serializable {
	...
	private void createRegistrationNumber() {
		if (count >= 0 & count < 1000) {
			count++;
			this.registrationNumber = String.format("S-%03d", count);
			
		}
		
	}
	
	public Servant(Name name, EGender gender, EMarried married, LocalDate dateOfBirth, String[] telephoneNumber,
	...
	public String toString() {
		return "Servant [registrationNumber=" + registrationNumber + ", getStartSalary()=" + getStartSalary()
